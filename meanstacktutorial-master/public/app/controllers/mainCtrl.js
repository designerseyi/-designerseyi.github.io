...
.controller('mainCtrl', function(Auth, $timeout, $location, $rootScope, $window, $interval, User, AuthToken, $scope) {
    var app = this;
     ...
     app.premaintemplates = ["myassets/css/bootstrap2.css",

                              "myassets/css/album.css",
                              
                              "myassets/css/floating-labels.css" ,

                              "myassets/webfonts/css/fontawesome-all.css",
    ...
    app.maintemplates =["mainassets/plugins/bootstrap/css/bootstrap.css",

                        "mainassets/plugins/node-waves/waves.css",
                        "mainassets/plugins/animate-css/animate.css",
                        "mainassets/css/style.css",
                        "mainassets/css/css/material-icons.css",
                        "mainassets/css/themes/all-themes.css",
                        "mainassets/css/webfonts/css/fontawesome-all.css",
                        "mainassets/adminlte/dist/css/AdminLTE.css",
                        "mainassets/plugins/jquery/jquery.min.js",
                        "mainassets/plugins/bootstrap/js/bootstrap.js"];
